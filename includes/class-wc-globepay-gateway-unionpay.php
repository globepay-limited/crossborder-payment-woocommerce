...
class WC_GlobePay_Unionpay extends WC_Payment_Gateway{
	...
	public function __construct(){
		...
		$this->id = "globepay_unionpay";

		// The Title shown on the top of the Payment Gateways Page next to all the other Payment Gateways
		$this->method_title='GlobePay - UnionPay';
	...
	public function get_icon() {
		...
		$icons_str = '<img src="' . GLOBEPAY_URL . '/assets/images/unionpay-logo.png" class="right-float" alt="UnionPay" style="height: 26px" />';
	...
	function init_form_fields() {
		$this->form_fields = array (
				'enabled' => array (
						...
						'type' => 'checkbox',
						'label' =>'Enable GlobePay - UnionPay',
						'default' => 'no',
						'section'=>'default'
				),
				'title' => array (
				...
				'description' => array (
						'title' => 'Description',
						'type' => 'textarea',
						'default' => 'Use UnionPay App to scan QR Code to complete payment',
						'desc_tip' => true,
						'css' => 'width:400px',
						'section'=>'default'
				),
	...
	public function process_payment($order_id){
		...
		try {
            $result = GlobePay_API::generate_globepay_order($order,'UnionPay',"https://pay.globepay.co/api/v1.0/web_gateway/partners/%s/orders/%s");
            $time=time().'000';
