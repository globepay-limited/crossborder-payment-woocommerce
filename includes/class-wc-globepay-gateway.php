...
class WC_GlobePay extends WC_Payment_Gateway {
    ...
    public function process_refund($order_id, $amount = null, $reason = '') {
        ...
        if (!$resArr) {
            return new WP_Error('refuse_error', json_encode($resArr,256));
        }
        ...
        try {
            ...
            <div style="padding-top:20px;">
                <div style="display: inline-block; margin: 0;">
                    <img style="width:300px;height:300px;display: block;"
                         src="<?php echo GLOBEPAY_URL ?>/includes/qrcode.php?data=<?php echo urlencode($result->code_url); ?>"/>
